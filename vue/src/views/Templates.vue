<template>
    <main>
        <div class="flex flex-no-wrap bg-gray-200 h-screen">
            <div
                class="w-50 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex"
            >
            ...
            <div class="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
                ...
                <!-- <div class="container">
                    <UnlayerEditor ref="emailEditor" :appearance="appreance" v-on:load="editorLoaded" v-on:ready="editorReady" class="shadow-md builder"/>
                </div> -->
            </div>
        </div>
    </main>
