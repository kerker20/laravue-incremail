<template>
  <main>
    <nav class="flex items-center justify-between flex-wrap bg-gray-800 sticky p-6">
          ...
          <ul class="mt-4">
            ...
            >
              <div class="flex items-center">
                ...
                <router-link :to="'/'" class="text-sm ml-2 text-blue-500">Templates</router-link>
              </div>
            </li>
            <router-link
              :to="{ name: 'Settings' }"
          ...
          <ul class="mt-4">
            ...
            >
              <div class="flex items-center">
                ...
                <router-link :to="'/dashboard'" class="text-sm ml-2 text-blue-500">Templates</router-link>
              </div>
            </router-link>
            <router-link
              :to="{ name: 'Settings' }"
            ...
            >
              ...
              >
                <div class="text-sm lg:flex-grow">
                  ...
                  >
                  <div class="ml-20">
                     <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1 px-3 rounded inline-flex items-center" v-on:click="saveDesign">
                      <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z" />
                      </svg>
                      <span>Save Design</span>
                    </button>
                    <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 ml-3 font-bold py-1 px-3 rounded inline-flex items-center" v-on:click="exportHtml">
                      <svg style="width:24px;height:24px" viewBox="0 0 24 24">
